...
const AdminEditBoardSelection: React.FC = () => {
  ...
  const [user, setUser] = useState(originalReservation.username || location.state?.username || "");
    ...
    <>
      <div className="pageContainer">
        <div className="boardSection">
          <Board title={`Admin Edit Reservation (user: ${user})`} room={selectedLab}>
...
export default AdminEditBoardSelection;